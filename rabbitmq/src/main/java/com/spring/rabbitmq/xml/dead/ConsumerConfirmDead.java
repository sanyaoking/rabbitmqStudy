 ...
 * @description:
 */
public class ConsumerConfirmDead {
    public static int flag = 0;
    public static void main(String[] args) {
        //创建Spring的ApplicationContext
        ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:xml/spring-ribbatmq-dead-consumer.xml");
        /**
         * 获取AmqpAdmin管理类
         */
        ...
        container.setQueueNames("dead_queue1");
        ...
        container.setMessageListener((ChannelAwareMessageListener) (message, channel) -> {
            ...
            if(flag/3==0){
                 ...
                 */
                /**
                 * 重新放入dear_queue1队列，然后其他可以继续被消费，直到进入其余两个分支，全部发往死信队列
                 */
